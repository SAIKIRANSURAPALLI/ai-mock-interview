  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/page-D8V6O7Lz0Pb1RFmrTpezN13XqfnJBi.js')",
        }}
      >
        <section className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              ...
              >
                <Sparkles className="mr-2 -ml-1 w-5 h-5" />
                Explore Features
              </a>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center md:flex-row md:justify-between">
              <div className="text-center md:text-left mb-4 md:mb-0">
                ...
                >
                  <div>
                    <label htmlFor="newsletter" className="text-sm mb-2">
                  ...
                  <div className="gap-2">
                    <input
                      ...
                      className="w-full md:w-64 p-2 mb-2 border border-gray-700 rounded-lg bg-gray-800 text-white placeholder-gray-400"
                      required
                    />
                    <button
                      type="submit"
                      className="bg-primary text-white py-2 px-4 rounded-lg hover:bg-primary-dark focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
                    >
                      Subscribe
                    </button>
                  </div>
